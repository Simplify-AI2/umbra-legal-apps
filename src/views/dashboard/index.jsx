...
const dashSalesData = [
  ...
  { title: 'AI Recommendations', amount: '$249.95', icon: 'icon-arrow-up text-c-green', value: 50, class: 'progress-c-theme' }
];
              ...
              <Card>
                ...
                <Card.Body>
                  {data.title !== 'AI Reviews' && data.title !== 'AI Recommendations' ? (
                    ...
                    // Content for AI Reviews and AI Recommendations cards goes here (currently empty as requested)
                    data.title === 'AI Reviews' ? (
                        aiReviewContent ? (
                            <p>{aiReviewContent}</p>
                        ) : (
                            <p>Upload a PDF to get AI Reviews.</p>
                        )
                    ) : data.title === 'AI Recommendations' ? (
